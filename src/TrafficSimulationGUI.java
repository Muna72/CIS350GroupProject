...
public class TrafficSimulationGUI extends JFrame implements ActionListener, Runnable{
    ...
    public static void main(String[] args) {
        try{
            final TrafficSimulationGUI gui = new TrafficSimulationGUI();
    ...
    public TrafficSimulationGUI(){
        ...
        trafficMap = new Simulation(secsTillNextVehicle, totalTime, 500, new RealRandom()); //TODO make lTime variable
