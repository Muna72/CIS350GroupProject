...
public class Simulation extends JPanel {
     ...
     */
    public Simulation(double secNext, double totTime, double laneTime, RandomInterface randomObject){
    ...
    public void addVehicle(boolean isUserCar){
        ...
        v.setCreateTime(getSimTimeLeft()); //TODO MAKE SIM STOP GENERATING CARS WHEN TIME IS GONNA RUN OUT
        isGoodDriver(v);
        placeVehicle(v);
        allVehicles.add(v);
        ++numOfVehicles;
